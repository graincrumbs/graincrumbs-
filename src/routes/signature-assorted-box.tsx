...
import { Check, Phone, ShieldCheck, Sparkles } from "lucide-react";
...
function SignatureAssortedBoxPage() {
  ...
  return (
    <>
      {/* Minimal top bar — logo only, no site navigation, so this stays a
          true single-product page (no way to browse other products). */}
      <header className="border-b border-border/60 bg-background/95">
        <div className="container-prose flex h-20 items-center gap-3">
